 ...
 */
export async function sendActivityUpdatedEmail({
  to,
  recipientName,
  title,
  typeKey,
  ...
  const { html, text, subject } = buildActivityUpdatedEmail({
    recipientName,
    title,
    typeKey,
    typeLabel: activityTypeLabel(typeKey),
 ...
 */
export async function sendActivityCancelledEmail({
  to,
  recipientName,
  title,
  typeKey,
  ...
  const { html, text, subject } = buildActivityCancelledEmail({
    recipientName,
    title,
    typeKey,
    typeLabel: activityTypeLabel(typeKey),
