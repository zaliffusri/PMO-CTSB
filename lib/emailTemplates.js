...
function calendarLinksHtml({ googleUrl, outlookUrl, cancelled = false } = {}) {
  if (cancelled) {
    return `<p style="margin:16px 0 0;font-size:13px;color:#64748b;">A calendar cancellation is attached — Outlook / Teams / Google Calendar should remove this event automatically (or open the .ics if it does not).</p>`;
  }
