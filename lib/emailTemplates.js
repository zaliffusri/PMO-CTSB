...
function calendarLinksHtml({ googleUrl, outlookUrl, cancelled = false } = {}) {
  if (cancelled) {
    return `<p style="margin:16px 0 0;font-size:13px;color:#64748b;">Outlook / Teams should remove this meeting from your calendar automatically. If it is still there, open the cancellation in Outlook and choose Remove from calendar.</p>`;
  }
