...
import { EPBT_MODULES } from './epbtModules.js';
...
export function defaultSettings() {
  return {
    ...
    /** ePBT / backlog / helpdesk module catalog ({ code, label }[]). */
    epbt_modules: EPBT_MODULES.map((m) => ({ ...m })),
    ...
    org_tagline: 'Technology-driven project office',
    org_logo_url: null,
    org_banner_url: null,
    /** SMTP — optional; falls back to process.env SMTP_* when empty. */
    smtp_service: '',
    smtp_host: '',
    smtp_port: 587,
    smtp_secure: false,
